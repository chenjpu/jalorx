...
import static io.jalorx.boot.mybatis.tx.SqlSessionUtils.closeSqlSession;
import static io.jalorx.boot.mybatis.tx.SqlSessionUtils.getSqlSession;
import static io.jalorx.boot.mybatis.tx.SqlSessionUtils.isSqlSessionTransactional;
...
public class SqlSessionTemplate implements SqlSession {
	...
	public <T> T selectOne(String statement) {
		return this.exec(session -> session.selectOne(statement));
	}
	...
	public <T> T selectOne(String statement, Object parameter) {
		return this.exec(session -> session.selectOne(statement, parameter));
	}
	...
	public <K, V> Map<K, V> selectMap(String statement, String mapKey) {
		return this.exec(session -> session.selectMap(statement, mapKey));
	}
	...
	public <K, V> Map<K, V> selectMap(String statement, Object parameter, String mapKey) {
		return this.exec(session -> session.selectMap(statement, parameter, mapKey));
	}
	...
	public <K, V> Map<K, V> selectMap(String statement, Object parameter, String mapKey,
			RowBounds rowBounds) {
		return this.exec(session -> session.selectMap(statement, parameter, mapKey, rowBounds));
	}
	...
	public <T> Cursor<T> selectCursor(String statement) {
		return this.exec(session -> session.selectCursor(statement));
	}
	...
	public <T> Cursor<T> selectCursor(String statement, Object parameter) {
		return this.exec(session -> session.selectCursor(statement, parameter));
	}
	...
	public <T> Cursor<T> selectCursor(String statement, Object parameter, RowBounds rowBounds) {
		return this.exec(session -> session.selectCursor(statement, parameter, rowBounds));
	}
	...
	public <E> List<E> selectList(String statement) {
		return this.exec(session -> session.selectList(statement));
	}
	...
	public <E> List<E> selectList(String statement, Object parameter) {
		return this.exec(session -> session.selectList(statement, parameter));
	}
	...
	public <E> List<E> selectList(String statement, Object parameter, RowBounds rowBounds) {
		return this.exec(session -> session.selectList(statement, parameter, rowBounds));
	}
	...
	public int insert(String statement) {
		return this.exec(session -> session.insert(statement));
	}
	...
	public int insert(String statement, Object parameter) {
		return this.exec(session -> session.insert(statement, parameter));
	}
	...
	public int update(String statement) {
		return this.exec(session -> session.update(statement));
	}
	...
	public int update(String statement, Object parameter) {
		return this.exec(session -> session.update(statement, parameter));
	}
	...
	public int delete(String statement) {
		return this.exec(session -> session.delete(statement));
	}
	...
	public int delete(String statement, Object parameter) {
		return this.exec(session -> session.delete(statement, parameter));
	}
	...
	public Connection getConnection() {
		return this.exec(session -> session.getConnection());
	}
	...
	public List<BatchResult> flushStatements() {
		return this.exec(session -> session.flushStatements());
	}

	protected <T> T exec(Function<SqlSession, T> call) {
		SqlSession sqlSession = getSqlSession(SqlSessionTemplate.this.sqlSessionFactory, SqlSessionTemplate.this.executorType);
		try {
			T result = call.apply(sqlSession);
