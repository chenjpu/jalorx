...
public class AnonymousGenerator extends AbstractJavaGenerator {

  public AnonymousGenerator(String project) {
    super(project);
  }
  ...
  public List<CompilationUnit> getCompilationUnits() {
    ...
    FullyQualifiedJavaType type = valueOf(
        String.format("%s.ui.%s.%s", basePackage, domain.toLowerCase(), "AnonymousResource"));
    ...
    topLevelClass
        .addAnnotation(String.format("@Resource(code = %s, desc = \"%s Resource\")", code, domain));
    topLevelClass.addAnnotation("@Operation.Anonymous");
