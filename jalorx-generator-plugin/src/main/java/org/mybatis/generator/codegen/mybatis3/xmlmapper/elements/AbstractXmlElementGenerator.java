...
public abstract class AbstractXmlElementGenerator extends AbstractGenerator {
    ...
    protected XmlElement getFilterElement() {
      XmlElement answer = new XmlElement("filter"); //$NON-NLS-1$
      answer.addAttribute(new Attribute("open","where ("));
      answer.addAttribute(new Attribute("close",")"));
      return answer;
  }
