...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByFilterElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByPrimaryKeyElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectByPrimaryKeysElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectCountByFilterElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
  ...
  protected XmlElement getSqlMapElement() {
    ...
    addSelectConutFilterClauseElement(answer);
    addSelectFilterClauseElement(answer);

    /*
     * 
     * addMyBatis3UpdateByExampleWhereClauseElement(answer); addBlobColumnListElement(answer);
     * addSelectByExampleWithBLOBsElement(answer); addSelectByExampleWithoutBLOBsElement(answer);
     * 
     * addDeleteByExampleElement(answer); addInsertElement(answer);
     * addInsertSelectiveElement(answer); addCountByExampleElement(answer);
     * addUpdateByExampleSelectiveElement(answer); addUpdateByExampleWithBLOBsElement(answer);
     * addUpdateByExampleWithoutBLOBsElement(answer); addUpdateByPrimaryKeySelectiveElement(answer);
  ...
  protected void addSelectFilterClauseElement(XmlElement parentElement) {
      AbstractXmlElementGenerator elementGenerator = new SelectByFilterElementGenerator();
      initializeAndExecuteGenerator(elementGenerator, parentElement);
  }


  protected void addSelectConutFilterClauseElement(XmlElement parentElement) {
      AbstractXmlElementGenerator elementGenerator = new SelectCountByFilterElementGenerator();
      initializeAndExecuteGenerator(elementGenerator, parentElement);
  }
  ...
  protected void addSelectByPrimaryKeyElement(XmlElement parentElement) {
    ...
    AbstractXmlElementGenerator elementGenerator = new SelectByPrimaryKeysElementGenerator();
    initializeAndExecuteGenerator(elementGenerator, parentElement);
  }
  protected void addSelectAllElement(XmlElement parentElement) {
    SelectAllElementGenerator elementGenerator = new SelectAllElementGenerator();
    initializeAndExecuteGenerator(elementGenerator, parentElement);
  }
