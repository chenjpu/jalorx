...
public abstract class IntrospectedTable {
  ...
  protected enum InternalAttribute {
    ATTR_PRIMARY_KEY_TYPE, ATTR_BASE_RECORD_TYPE, ATTR_RECORD_WITH_BLOBS_TYPE, ATTR_EXAMPLE_TYPE, ATTR_MYBATIS3_XML_MAPPER_PACKAGE, ATTR_MYBATIS3_XML_MAPPER_FILE_NAME,
  ...
  protected String calculateJavaModelPackage() {
    ...
    return this.getBasePackage() + ".model";
  ...
  protected void calculateBasePackage() {
    String basePackage = context.getProperty("basePackage");
    setBasePackage(basePackage);
    
    String code = context.getProperty("code");
    setCode(code);
  }
  ...
  public void setBasePackage(String basePackage) {
    internalAttributes.put(InternalAttribute.ATTR_BASE_PACKAGE, basePackage);
  }
  public void setCode(String code) {
    internalAttributes.put(InternalAttribute.ATTR_CODE, code);
  }
  ...
  public void setMyBatis3FallbackSqlMapNamespace(String sqlMapNamespace) {
    internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_FALLBACK_SQL_MAP_NAMESPACE,
        sqlMapNamespace);
  }
  ...
  public void setMyBatis3XmlMapperPackage(String mybatis3XmlMapperPackage) {
    internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_PACKAGE,
  ...
  public void setMyBatis3XmlMapperFileName(String mybatis3XmlMapperFileName) {
    internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_XML_MAPPER_FILE_NAME,
  ...
  public void setMyBatis3SqlProviderType(String mybatis3SqlProviderType) {
    internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_SQL_PROVIDER_TYPE,
  ...
  public String getBasePackage() {
    return internalAttributes.get(InternalAttribute.ATTR_BASE_PACKAGE);
  }
  public String getCode() {
    return internalAttributes.get(InternalAttribute.ATTR_CODE);
  }
